...
public class QuanLyPTGT {
    ...
    float GiáBán,NămSX;
public QuanLyPTGT(){ }
    public QuanLyPTGT(int ID,String HãngSX,float NămSX,float GiáBán,String Màu, int SốChỗNgồi,String KiểuĐộngCơ,String CôngSuất,String TrọngTải){
    this.ID= ID;
    this.NămSX = NămSX;
    this.HãngSX = HãngSX;
    this.Màu = Màu;
    ...
    public QuanLyPTGT(String HãngSX,float NămSX,float GiáBán,String Màu, int SốChỗNgồi,String KiểuĐộngCơ,String CôngSuất,String TrọngTải){
        this.NămSX = NămSX;
        this.HãngSX = HãngSX;
        this.Màu = Màu;
        this.KiểuĐộngCơ= KiểuĐộngCơ;
